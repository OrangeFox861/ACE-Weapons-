...
SWEP.ViewModel = "models/ace+/v_rpg26.mdl"
SWEP.WorldModel = "models/ace+/w_rpg26.mdl"
SWEP.HoldType = "rpg"
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 3770 --He Filler or Flechette count
	...
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				MotorSound = "acf_extra/cannons/50mm-107mm/cannon_50to75/cannon_57mm_long.wav",
				--acf_extra/cannons/50mm-107mm/cannon_76to99/77mm_qqf.wav
				--acf_extra/cannons/mortars-launchers/mortar_81mm.wav
