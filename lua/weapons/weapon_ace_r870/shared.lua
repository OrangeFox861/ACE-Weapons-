...
SWEP.Purpose = "USA shotgun (caliber 4mm because no one wants to catch 12mm pellets)"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 1.5 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_r870.mdl"
SWEP.WorldModel = "models/ace+/w_r870.mdl"
...
sound.Add( {
    name = "CA.r870.shellin",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/r870/reload1.wav"
} )
sound.Add( {
    name = "CA.R870.Pump",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/r870/select.wav"
} )
