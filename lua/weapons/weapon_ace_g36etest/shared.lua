...
SWEP.Purpose = "i dont now but NATO shooter!"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 12,5 --Rounds per second

SWEP.Primary.ClipSize = 30
SWEP.Primary.DefaultClip = 180
SWEP.Primary.Automatic = true
SWEP.Primary.Ammo = "AR2"
SWEP.Primary.Sound = "weapons/test_multi.mp3"
...
SWEP.ViewModel = "models/ace+/v_g36e.mdl"
SWEP.WorldModel = "models/ace+/w_g36e.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 1 + ang:Up() * -3 + ang:Forward() * 5
return pos, ang
end
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g36e/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g36e/reload2.wav"
} )
sound.Add( {
    name = "CA.G36E.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g36e/reload3.wav"
} )
sound.Add( {
    name = "CA.G36E.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g36e/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	--self.BulletData.DragCoef = 0.001 --Alternatively manually set it
