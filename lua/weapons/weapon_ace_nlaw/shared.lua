...
--Main settings--
SWEP.Primary.Delay = 1 --Reload in seconds
...
SWEP.TrackSound = "none"
SWEP.LockSound = "buttons/button16.wav"

SWEP.DirectFireDist = 1205 * 39.37
...
SWEP.HeatAboveAmbient = 19 --Minimum Seeker Temp
...
function SWEP:GetWhitelistedEntsInCone()
	...
	local MaximumDistance = 450  *  39.37
...
function SWEP:PrimaryAttack()
	...
	if SERVER and IsValid( self.TarEnt ) and self:GetLaunchAuth() then
		...
		local MDat = {
			...
			Ang = owner:GetAimVector():Angle() + Angle(-2, 0, 0),
