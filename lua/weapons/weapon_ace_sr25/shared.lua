...
--Main settings--
SWEP.FireRate = 7 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_sr25.mdl"
SWEP.WorldModel = "models/ace+/w_sr25.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 1 + ang:Up() * -4 + ang:Forward() * 9
return pos, ang
end
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 5.5 --Volume of the case as a cylinder * Powder density converted from g to kg
