...
SWEP.Purpose = "Mod NATO bullet shooter"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 13.33 --Rounds per second
...
SWEP.HeatReductionRate = 949.05 --Heat loss per second when not firing
SWEP.HeatPerShot = 18.15 --Heat generated per shot
SWEP.HeatMax = 18.15 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 18.15	--Amount of angular recoil
...
SWEP.ViewPunchAmount = 0.91 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
SWEP.ViewPunchAmountSide = 0.15
SWEP.ViewPunchAmountRoll = 0.45
...
SWEP.ViewModel = "models/ace+/v_m16a3.mdl"
SWEP.WorldModel = "models/ace+/w_m16a3.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 1 + ang:Up() * -4 + ang:Forward() * 7
return pos, ang
end


sound.Add( {
    name = "CA.m16a3.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m16a3/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m16a3/reload2.wav"
} )
sound.Add( {
    name = "CA.m16a3.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m16a3/reload3.wav"
} )
sound.Add( {
    name = "CA.m16a3.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m16a3/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 9.5 --Volume of the case as a cylinder * Powder density converted from g to kg
