...
SWEP.Purpose = "Powerful slavic sniper rifle"
SWEP.Spawnable = true
...
SWEP.Primary.Sound = "weapons/sv98_multi.mp3"
...
SWEP.HeatPerShot = 25 --Heat generated per shot
...
SWEP.ViewModel = "models/ace+/v_sv98.mdl"
SWEP.WorldModel = "models/ace+/w_sv98.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/sv98/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/sv98/reload2.wav"
} )
sound.Add( {
    name = "CA.sv98.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/sv98/reload3.wav"
} )
sound.Add( {
    name = "CA.sv98.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/sv98/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 32 --Volume of the case as a cylinder * Powder density converted from g to kg
	...
	self.BulletData.PenArea = self.BulletData.FrArea ^ ACF.PenAreaMod * 6
