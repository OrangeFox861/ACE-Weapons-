...
SWEP.Purpose = "Sneaky sniper slavic"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 15 --Rounds per second
...
SWEP.Primary.LightScale = 1 --Muzzleflash light radius
...
SWEP.HeatReductionRate = 325 --Heat loss per second when not firing
...
SWEP.ViewPunchAmount = 0.18 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
SWEP.AccurateCrosshair = true

--Spread (aimcone) settings--
SWEP.BaseSpread = 0.1 --First-shot random spread, in degrees
SWEP.MaxSpread = 1.1 --Maximum added random spread from heat value, in degrees
...
SWEP.ViewModel = "models/ace+/v_vss.mdl"
SWEP.WorldModel = "models/ace+/w_vss.mdl"
SWEP.HoldType = "smg"
...
pos = pos + ang:Right() * -1.5 + ang:Up() * 0 + ang:Forward() * -1.5
return pos, ang
end
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/as_val/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/as_val/reload2.wav"
} )
sound.Add( {
    name = "CA.vss.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/as_val/reload3.wav"
} )
sound.Add( {
    name = "CA.vss.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/as_val/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 1.6 --Volume of the case as a cylinder * Powder density converted from g to kg
