...
SWEP.Purpose = "NATO bullet thrower"
SWEP.Spawnable = true
SWEP.Slot = 2
SWEP.SlotPos = 1
SWEP.Author = " "
...
SWEP.Primary.Sound = "weapons/g3_multi.mp3"
...
SWEP.HeatPerShot = 32.67 --Heat generated per shot
SWEP.HeatMax = 32.67 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 32.67	--Amount of angular recoil
...
SWEP.ViewPunchAmount = 1.64 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
SWEP.ViewPunchAmountSide = 0.1
SWEP.ViewPunchAmountRoll = 0.82
...
SWEP.ViewModel = "models/ace+/v_g3.mdl"
SWEP.WorldModel = "models/ace+/w_g3.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g3/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g3/reload2.wav"
} )
sound.Add( {
    name = "CA.G3.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/g3/reload3.wav"
} )
sound.Add( {
    name = "CA.G3.Select",
    channel = CHAN_STATIC,
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 6.4 --Volume of the case as a cylinder * Powder density converted from g to kg
	self.BulletData.ProjLength = 4.2 --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
