...
SWEP.HeatReductionRate = 1165.5 --Heat loss per second when not firing
SWEP.HeatPerShot = 39.93 --Heat generated per shot
SWEP.HeatMax = 39.93 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 39.93	--Amount of angular recoil
