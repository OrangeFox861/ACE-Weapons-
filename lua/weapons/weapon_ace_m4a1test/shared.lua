SWEP.PrintName = "M4A1 TEST"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "/PUBLIC TEST"
SWEP.Purpose = "Compact USA bullet shooter"
SWEP.Spawnable = true
...
SWEP.HeatReductionRate = 666 --Heat loss per second when not firing
...
SWEP.ViewModel = "models/ace+/v_m4a1.mdl"
SWEP.WorldModel = "models/ace+/w_m4a1.mdl"
SWEP.HoldType = "ar2"
