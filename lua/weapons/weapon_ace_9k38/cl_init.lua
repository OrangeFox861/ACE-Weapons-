...
function SWEP:DoDrawCrosshair(x, y)
	...
	if Zoom then
			surface.DrawCircle( x, y, 200, Color( 255, 150, 0 ) )
		local tempcolor = Color(255, 150, 0)
		local thiccness = 10
		...
		if self:GetLockProgress() > 0 then
			surface.DrawCircle(x + math.Clamp(tarpos2d.x - x, -215, 215), y + math.Clamp(tarpos2d.y - y, -215, 215), 10, tempcolor)
		end
