SWEP.PrintName = "9K38 Igla"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "Igla (GRAU index - 9K38, (US and NATO code designation - SA-18 Grouse) - Soviet portable anti-aircraft missile system"
SWEP.Spawnable = true
...
SWEP.TrackSound = "acf_extra/ace/flightwarning/rwr1_ru/launchwarn.wav"
SWEP.LockSound = "acf_extra/ace/flightwarning/rwr1_ru/lockwarn.wav"
...
SWEP.ViewModel = "models/ace+/v_igla.mdl"
SWEP.WorldModel = "models/ace+/w_igla.mdl"
SWEP.HoldType = "rpg"
...
SWEP.IronSightsPos = Vector( 3, 0, -6 )
SWEP.IronSightsAng = Vector( 0, 0, 0 )

SWEP.SeekSensitivity = 1.8

SWEP.Lockrate = 0.05 --Lock rate per second
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 1380 --He Filler or Flechette count
...
function SWEP:GetWhitelistedEntsInCone()
	...
	local MaximumDistance = 1050  *  39.37
