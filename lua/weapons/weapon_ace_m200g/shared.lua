SWEP.PrintName = "M 200 gillie"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Sniper Rifles"
SWEP.Purpose = "Very powerful mod grassy sniper rifle"
SWEP.Spawnable = true
...
SWEP.Primary.Sound = "weapons/m200g_multi.mp3"
...
SWEP.AngularRecoil = 35	--Amount of angular recoil
...
SWEP.ViewModel = "models/ace+/v_m200g.mdl"
SWEP.WorldModel = "models/ace+/w_m200g.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.m200g.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m200/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m200/reload2.wav"
} )
sound.Add( {
    name = "CA.m200g.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m200/reload3.wav"
} )
sound.Add( {
    name = "CA.m200g.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m200/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.Caliber = 1.03
	self.BulletData.PropLength = 41 --Volume of the case as a cylinder * Powder density converted from g to kg
	self.BulletData.ProjLength = 22 --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
