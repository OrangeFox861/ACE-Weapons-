...
SWEP.Purpose = "Enhanced Marksman Rifle"
...
SWEP.ViewModel = "models/ace+/v_m39_emr.mdl"
SWEP.WorldModel = "models/ace+/w_m39_emr.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m14/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m14/reload2.wav"
} )
sound.Add( {
    name = "CA.m14.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m14/reload3.wav"
} )
sound.Add( {
    name = "CA.m14.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/m14/select.wav"
} )
