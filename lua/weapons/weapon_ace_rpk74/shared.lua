...
SWEP.ViewModel = "models/ace+/v_rpk74.mdl"
SWEP.WorldModel = "models/ace+/w_rpk74.mdl"
SWEP.HoldType = "ar2"
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 7.2 --Volume of the case as a cylinder * Powder density converted from g to kg
