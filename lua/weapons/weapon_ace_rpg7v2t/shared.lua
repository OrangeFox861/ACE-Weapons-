SWEP.PrintName = "RPG 7v2 (PG-7VR)"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "Сult tandem slavic RPG"
SWEP.Spawnable = true
...
SWEP.Primary.Sound = "acf_extra/cannons/mortars-launchers/mortar_82mm.wav"
...
SWEP.ViewModel = "models/ace+/c_rpgv2t.mdl"
SWEP.WorldModel = "models/ace+/c_rpgv2t.mdl"
SWEP.HoldType = "rpg"
...
pos = pos + ang:Right() * 0 + ang:Up() * 0 + ang:Forward() * 10
return pos, ang
end
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 11000 --He Filler or Flechette count
...
function SWEP:PrimaryAttack()
	...
	if (IsFirstTimePredicted() or game.SinglePlayer()) and owner:IsPlayer() then
		self:GetOwner():ViewPunch(Angle(-13, 0, 0))
	end
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				MotorSound = "acf_extra/ace/missiles/launch/bgmtow.wav",
