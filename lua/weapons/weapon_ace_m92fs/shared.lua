...
--Main settings--
SWEP.FireRate = 8.3 --Rounds per second
...
SWEP.HeatPerShot = 9 --Heat generated per shot
SWEP.HeatMax = 9 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.CrouchRecoilBonus = 0.65 --Reduce recoil by this amount when crouching
...
SWEP.CarrySpeedMul			= 1

--Model settings--
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/ace+/v_m92fs.mdl"
SWEP.WorldModel = "models/ace+/w_m92fs.mdl"
...
pos = pos + ang:Right() * 0 + ang:Up() * -1 + ang:Forward() * 5
return pos, ang
end
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetAng = Angle(-175, 0, 90)
...
sound.Add( {
    name = "CA.M92FS.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ps/g18/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ps/g18/reload2.wav"
} )
sound.Add( {
    name = "CA.M92FS.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ps/g18/reload3.wav"
} )
sound.Add( {
    name = "CA.M92FS.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ps/g18/reload3.wav"
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 1.4 --Volume of the case as a cylinder * Powder density converted from g to kg
