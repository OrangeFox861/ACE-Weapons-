...
SWEP.HeatReductionRate = 350 --Heat loss per second when not firing
SWEP.HeatPerShot = 11 --Heat generated per shot
SWEP.HeatMax = 63.75 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 28.68	--Amount of angular recoil
...
SWEP.ViewModel = "models/ace+/v_scarh.mdl"
SWEP.WorldModel = "models/ace+/w_scarh.mdl"
SWEP.HoldType = "ar2"
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetAng = Angle(200, 0, 90)
...
sound.Add( {
    name = "CA.SCARH.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/scar_h/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/scar_h/reload2.wav"
} )
sound.Add( {
    name = "CA.SCARH.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/scar_h/reload3.wav"
} )
sound.Add( {
    name = "CA.SCARH.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/scar_h/reload1.wav"
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 4.1 --Volume of the case as a cylinder * Powder density converted from g to kg
