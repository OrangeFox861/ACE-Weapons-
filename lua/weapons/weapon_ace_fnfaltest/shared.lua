...
SWEP.HeatReductionRate = 1498.5 --Heat loss per second when not firing
SWEP.HeatPerShot = 29.04 --Heat generated per shot
SWEP.HeatMax = 29.04 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 29.04	--Amount of angular recoil
...
SWEP.ViewPunchAmount = 1.45 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
SWEP.ViewPunchAmountSide = 0.1
SWEP.ViewPunchAmountRoll = 0.73
...
SWEP.ViewModel = "models/ace+/v_parafal.mdl"
SWEP.WorldModel = "models/ace+/w_parafal.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.PARAFAL.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/parafal/reload1.wav"
} )

sound.Add( {
    name = "CA.PARAFAL.Magin",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/parafal/reload2.wav"
} )
sound.Add( {
    name = "CA.PARAFAL.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/parafal/select.wav"
} )
sound.Add( {
    name = "CA.PARAFAL.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/parafal/select.wav"
