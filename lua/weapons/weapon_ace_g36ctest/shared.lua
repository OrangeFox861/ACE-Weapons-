...
SWEP.Purpose = "Compact bullet shooter"
SWEP.Spawnable = true
...
SWEP.ViewModel = "models/ace+/v_g36c.mdl"
SWEP.WorldModel = "models/ace+/w_g36c.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m4a1/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m4a1/reload2.wav"
} )
sound.Add( {
    name = "CA.g36c.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m4a1/reload3.wav"
} )
sound.Add( {
    name = "CA.g36c.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m4a1/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.ProjLength = 5.5 --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
