...
SWEP.Purpose = "Bullpup NATO shooter!"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 10.8 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_l85a1.mdl"
SWEP.WorldModel = "models/ace+/w_l85a1.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.l85a1.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/l85a1/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/l85a1/reload2.wav"
} )
sound.Add( {
    name = "CA.l85a1.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/l85a1/reload3.wav"
} )
sound.Add( {
    name = "CA.l85a1.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/l85a1/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 11.9 --Volume of the case as a cylinder * Powder density converted from g to kg
