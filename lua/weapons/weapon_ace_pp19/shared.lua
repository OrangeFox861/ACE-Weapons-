...
SWEP.ViewModel = "models/ace+/v_pp19.mdl"
SWEP.WorldModel = "models/ace+/w_pp19.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74m/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74m/reload2.wav"
} )
sound.Add( {
    name = "CA.PP19.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74m/reload3.wav"
} )
sound.Add( {
    name = "CA.PP19.Select",
    channel = CHAN_STATIC,
