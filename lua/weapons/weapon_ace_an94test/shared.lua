...
SWEP.Purpose = "Expensive slavik  bullet shooter"
SWEP.Spawnable = true
...
SWEP.HeatPerShot = 19.96 --Heat generated per shot
SWEP.HeatMax = 19.96 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 19.96	--Amount of angular recoil
...
SWEP.ViewModel = "models/ace+/v_an94.mdl"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/an-94/reload2.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/an-94/reload1.wav"
} )
sound.Add( {
    name = "CA.AN94.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/an-94/reload3.wav"
} )
sound.Add( {
    name = "CA.AN94.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/an-94/select.wav"
} )
