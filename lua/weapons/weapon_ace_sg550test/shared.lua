...
--Main settings--
SWEP.FireRate = 11.6 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_sg550.mdl"
SWEP.WorldModel = "models/ace+/w_sg550.mdl"
SWEP.HoldType = "ar2"
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetVec = Vector(7, -2, -2)
			local offsetAng = Angle(170, 180, 90)
...
sound.Add( {
    name = "CA.sg550.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/sg550/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/sg550/reload2.wav"
} )
sound.Add( {
    name = "CA.sg550.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/sg550/reload3.wav"
} )
sound.Add( {
    name = "CA.sg550.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/sg550/select.wav"
} )
