...
SWEP.Purpose = "old slavic bratatata"
SWEP.Spawnable = true
...
SWEP.AngularRecoil = 39.4	--Amount of angular recoil
...
SWEP.ViewModel = "models/ace+/v_rpk.mdl"
SWEP.WorldModel = "models/ace+/w_rpk.mdl"
SWEP.HoldType = "ar2"
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetAng = Angle(180, 90, 80)
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/rpk74/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/rpk74/reload2.wav"
} )
sound.Add( {
    name = "CA.RPK.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/rpk74/reload3.wav"
} )
sound.Add( {
    name = "CA.RPK.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/rpk74/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 6.1 --Volume of the case as a cylinder * Powder density converted from g to kg
