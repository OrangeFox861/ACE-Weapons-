SWEP.PrintName = "9K32 Strela-2"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "Strela-2 (GRAU index - 9K32, according to the classification of the US Ministry of Defense and NATO SA-7 Grail) - Soviet portable anti-aircraft missile system"
SWEP.Spawnable = true
...
SWEP.TrackSound = "acf_extra/ACE/miscellaneous/alarms/Alarm2.wav"
SWEP.LockSound = "acf_extra/ACE/miscellaneous/alarms/Alarm1.wav"
...
SWEP.ViewModel = "models/ace+/v_strela.mdl"
SWEP.WorldModel = "models/ace+/w_strela.mdl"
SWEP.HoldType = "rpg"
...
SWEP.IronSightsPos = Vector( -10, -20, -2 )
SWEP.IronSightsAng = Vector( 0, 0, 0 )

SWEP.SeekSensitivity = 1.2

SWEP.Lockrate = 0.035 --Lock rate per second
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetAng = Angle(11, 0, 180)
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 1080 --He Filler or Flechette count
...
function SWEP:GetWhitelistedEntsInCone()
	...
	local MaximumDistance = 550  *  39.37
...
local MDat = {
    ...
    Mdl = "models/missiles/fim_92.mdl",  -- Using Stinger model for AA missile
    ...
    Drag = 0.003,
    GuidanceName = "Infrared",  -- Infrared homing for low-flying targets
    FuseName = "Overshoot",
    HasInertial = false,
    HasDatalink = false,
