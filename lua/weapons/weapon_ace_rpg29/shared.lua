SWEP.PrintName = "RPG 29"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "old heavy slavic RPG"
SWEP.Spawnable = true
...
SWEP.Primary.Sound = "acf_extra/cannons/50mm-107mm/cannon_100to110/cannon_107mm.wav"
...
SWEP.ViewModel = "models/ace+/v_rpg29.mdl"
SWEP.WorldModel = "models/ace+/w_rpg29.mdl"
SWEP.HoldType = "rpg"
...
pos = pos + ang:Right() * 3.5 + ang:Up() * -4  + ang:Forward() * -8
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 11500 --He Filler or Flechette count
	...
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				MotorSound = "acf_extra/cannons/50mm-107mm/cannon_100to110/cannon_105mm.wav",
