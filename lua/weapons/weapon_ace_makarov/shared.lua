...
SWEP.HeatMax = 7 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.ViewModel = "models/ace+/v_makarov.mdl"
SWEP.WorldModel = "models/ace+/w_makarov.mdl"
...
pos = pos + ang:Right() * 0 + ang:Up() * 0 + ang:Forward() * 3
return pos, ang
end
