...
SWEP.Purpose = "baguette shotgun (caliber 4mm because no one wants to catch 12mm pellets)"
SWEP.Spawnable = true
...
SWEP.Primary.BulletCount = 12 --Number of bullets to fire each shot, used for shotguns

SWEP.ReloadSound = "Weapon_shotgun.Reload" --Sound other players hear when you reload - this is NOT your first-person sound
...
SWEP.ViewPunchAmount =3--grees to punch the view upwards each shot - does not actually move crosshair, just a visual effect


--Spread (aimcone) settings--
SWEP.BaseSpread = 1.2 --First-shot random spread, in degrees
...
SWEP.MovementSpread = 1.2 --Increase aimcone to this many degrees when sprinting at full speed
SWEP.UnscopedSpread = 0 --Spread, in degrees, when unscoped with a scoped weapon


--Model settings--
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/ace+/v_spas12.mdl"
SWEP.WorldModel = "models/ace+/w_spas12.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.SPAS12.shellin",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/SPAS12/reload1.wav"
} )
sound.Add( {
    name = "CA.spas12.Pump",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/spas12/select.wav"
} )
