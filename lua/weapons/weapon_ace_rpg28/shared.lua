...
SWEP.ViewModel = "models/ace+/rpg28_launcher.mdl"
SWEP.WorldModel = "models/ace+/rpg28_launcher.mdl"
SWEP.HoldType = "rpg"
...
pos = pos + ang:Right() * 6 + ang:Up() * -12 + ang:Forward() * 13
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 20000 --He Filler or Flechette count
	...
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				MotorSound = "acf_extra/cannons/120mm-240mm/cannon_120mm/cannon_120mm_smoothbore.wav",
