...
SWEP.PrintName = "MSG 90"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Sniper Rifles"
SWEP.Purpose = "NATO accurate bullet thrower"
SWEP.Spawnable = true
SWEP.Slot = 2
SWEP.SlotPos = 1
SWEP.Author = " "
...
--Main settings--
SWEP.FireRate = 6 --Rounds per second
...
SWEP.HeatMax = 55.5 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 35.6	--Amount of angular recoil
...
SWEP.UnscopedSpread = 4 --Spread, in degrees, when unscoped with a scoped weapon

--Model settings--
SWEP.ViewModelFlip = false
SWEP.ViewModel = "models/ace+/v_msg90.mdl"
SWEP.WorldModel = "models/ace+/w_msg90.mdl"
SWEP.HoldType = "ar2"
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 7.8 --Volume of the case as a cylinder * Powder density converted from g to kg
