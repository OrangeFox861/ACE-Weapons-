SWEP.PrintName = "Carl Gustaf M2 (HEDP 502)"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "Carl Gustafs Stads Gevärsfaktori"
SWEP.Spawnable = true
...
SWEP.Primary.Sound = "acf_extra/ace/missiles/launch/strela.wav"
...
SWEP.ViewModel = "models/ace+/v_cgm3.mdl"
SWEP.WorldModel = "models/ace+/w_cgm3.mdl"
SWEP.HoldType = "rpg"
...
function SWEP:InitBulletData()
	...
	self.BulletData.Type = "HESH"
	self.BulletData.Id = 2
	self.BulletData.Caliber = 8.4 --1 = 84 m/s
	...
	self.BulletData.Data5 = 1300 --He Filler or Flechette count
	...
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				Mdl = "models/munitions/round_100mm_shot.mdl",
				...
				MotorSound = "acf_extra/cannons/mortars-launchers/grenade_launcher_40mm.wav",
				BoostEffect = "ThumperDust",
				MotorEffect = "ThumperDust"
			}
