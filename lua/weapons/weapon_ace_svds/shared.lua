SWEP.PrintName = "SVDS gillie"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Sniper Rifles"
SWEP.Purpose = "Stealthy Grassy Slavic Sniper Rifle"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 2 --Rounds per second

SWEP.Primary.ClipSize = 10
SWEP.Primary.DefaultClip = 60
SWEP.Primary.Automatic = false
SWEP.Primary.Ammo = "XBowBolt"
SWEP.Primary.Sound = "weapons/svd_multi.mp3"
...
SWEP.ViewModel = "models/ace+/v_dragunovsvdsg.mdl"
SWEP.WorldModel = "models/ace+/w_dragunovsvdsg.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.dragunov.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/dragunov/reload1.wav"
} )

sound.Add( {
    name = "CA.dragunov.Magin",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/dragunov/reload2.wav"
} )
sound.Add( {
    name = "CA.dragunov.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/dragunov/reload3.wav"
} )
sound.Add( {
    name = "CA.dragunov.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sr/dragunov/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PropLength = 19 --Volume of the case as a cylinder * Powder density converted from g to kg
	self.BulletData.ProjLength = 10 --Volume of the projectile as a cylinder * streamline factor (Data5) * density of steel
