SWEP.PrintName = "Binocular"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "a great way to measure the distance"
SWEP.Spawnable = true
...
SWEP.AngularRecoil = 37.5	--Amount of angular recoil
...
SWEP.ViewModel = "models/ace+/c_binoculars_usa.mdl"
SWEP.WorldModel = "models/ace+/c_binoculars_usa.mdl"
SWEP.HoldType = "slam"
SWEP.DeployDelay = 1000 --Time before you can fire after deploying the weapon
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetVec = Vector(-5, 15, 0)
			local offsetAng = Angle(-190, -190, 90)
