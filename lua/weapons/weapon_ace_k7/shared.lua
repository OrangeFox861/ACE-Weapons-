...
SWEP.Purpose = "Veru fast but very weak at a distance"
SWEP.Spawnable = true
...
SWEP.AngularRecoil = 14	--Amount of angular recoil
...
SWEP.ViewModel = "models/ace+/v_k7.mdl"
SWEP.WorldModel = "models/ace+/w_k7.mdl"
SWEP.HoldType = "smg"
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/k1a/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/k1a/reload2.wav"
} )
sound.Add( {
    name = "CA.k7.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/k1a/reload3.wav"
} )
sound.Add( {
    name = "CA.k7.Select",
    channel = CHAN_STATIC,
