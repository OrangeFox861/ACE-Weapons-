SWEP.PrintName = "RGW-90 Matador"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "90mm disposable grenade launcher developed through cooperation between Singapore and Israel"
SWEP.Spawnable = true
...
SWEP.Primary.Sound = "acf_extra/cannons/50mm-107mm/cannon_50to75/cannon_75mm.wav"
...
SWEP.ViewModel = "models/ace+/v_mat.mdl"
SWEP.WorldModel = "models/ace+/w_gdcw_matador_rl.mdl"
SWEP.HoldType = "rpg"
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetVec = Vector(16, 0, -3)
			local offsetAng = Angle(-10, 180, 180)
...
function SWEP:InitBulletData()
	...
	self.BulletData.Data5 = 6100 --He Filler or Flechette count
	self.BulletData.Data6 = 70 --HEAT ConeAng or Flechette Spread
	...
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				Pos = owner:GetShootPos() + owner:GetAimVector() * 1300,
				...
				MotorSound = "acf_extra/cannons/50mm-107mm/cannon_100to110/cannon_100mm_d10.wav",
