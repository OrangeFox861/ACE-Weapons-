SWEP.PrintName = "AK-74M TEST"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "/PUBLIC TEST"
SWEP.Purpose = "Slavik bullet shooter"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 10.41 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_ak74m.mdl"
SWEP.WorldModel = "models/ace+/w_ak74m.mdl"
SWEP.HoldType = "ar2"
