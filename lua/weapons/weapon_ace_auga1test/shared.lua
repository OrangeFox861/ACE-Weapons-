...
--Main settings--
SWEP.FireRate = 11.8 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_auga1.mdl"
SWEP.WorldModel = "models/ace+/w_auga1.mdl"
SWEP.HoldType = "smg"
...
sound.Add( {
    name = "CA.auga1.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/auga1/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/auga1/reload2.wav"
} )
sound.Add( {
    name = "CA.auga1.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/auga1/reload3.wav"
} )
sound.Add( {
    name = "CA.auga1.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/auga1/select.wav"
} )
