...
--Main settings--
SWEP.FireRate = 10.5 --Rounds per second
...
SWEP.ViewModel = "models/ace+/v_scar_l.mdl"
SWEP.WorldModel = "models/ace+/w_scar_l.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.SCARL.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/SCAR_L/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/SCAR_L/reload2.wav"
} )
sound.Add( {
    name = "CA.SCARL.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/SCAR_L/reload3.wav"
} )
sound.Add( {
    name = "CA.SCARL.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/SCAR_L/select.wav"
} )
