...
SWEP.HeatMax = 12 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 12	--Amount of angular recoil
...
SWEP.BaseSpread = 0.32 --First-shot random spread, in degrees
...
SWEP.ViewModel = "models/ace+/v_g23.mdl"
SWEP.WorldModel = "models/ace+/w_g23.mdl"
...
pos = pos + ang:Right() * 0 + ang:Up() * -2 + ang:Forward() * 5
return pos, ang
end
