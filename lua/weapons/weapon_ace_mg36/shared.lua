...
SWEP.Purpose = "scoped machine gun!"
SWEP.Spawnable = true
...
SWEP.ViewModel = "models/ace+/v_mg36.mdl"
SWEP.WorldModel = "models/ace+/w_mg36.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 0 + ang:Up() * 0 + ang:Forward() * -1
return pos, ang
end
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/mg36/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/mg36/reload3.wav"
} )
sound.Add( {
    name = "CA.MG36.Handle",
    channel = CHAN_STATIC,
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/lmg/mg36/select.wav"
} )
