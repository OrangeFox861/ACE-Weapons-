...
SWEP.HeatReductionRate = 1082 --Heat loss per second when not firing
SWEP.HeatPerShot = 22.5 --Heat generated per shot
SWEP.HeatMax = 22.5 --Maximum heat - determines max rate at which recoil is applied to eye angles
