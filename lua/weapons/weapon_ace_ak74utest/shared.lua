...
SWEP.Purpose = "Compact slavic bullet shooter"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 11.25 --Rounds per second
...
SWEP.HeatReductionRate = 999 --Heat loss per second when not firing
SWEP.HeatPerShot = 21.78 --Heat generated per shot
SWEP.HeatMax = 21.78 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 21.78	--Amount of angular recoil
...
SWEP.ViewPunchAmount = 1.09 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
SWEP.ViewPunchAmountSide = 0.15
SWEP.ViewPunchAmountRoll = 0.55
...
SWEP.ViewModel = "models/ace+/v_ak74u.mdl"
SWEP.WorldModel = "models/ace+/w_ak74u.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 1 + ang:Up() * -5 + ang:Forward() * 9
return pos, ang
end
...
sound.Add( {
    name = "CA.AK74u.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74u/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74u/reload2.wav"
} )
sound.Add( {
    name = "CA.AK74u.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74u/reload3.wav"
} )
sound.Add( {
    name = "CA.AK74u.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak74u/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	self.BulletData.PenArea = self.BulletData.FrArea ^ ACF.PenAreaMod * 1.9
