SWEP.PrintName = "RPO-A Shmel"
SWEP.Base = "weapon_ace_base"
SWEP.Category = "ACE Weapons+"
SWEP.SubCategory = "Special"
SWEP.Purpose = "slavic Шайта́н-труба́ (Shaitan-trumpet)"
SWEP.Spawnable = true
...
SWEP.ViewModel = "models/ace+/v_shmel.mdl"
SWEP.WorldModel = "models/ace+/w_shmel.mdl"
SWEP.HoldType = "rpg"
...
pos = pos + ang:Right() * 3 + ang:Up() * -2 + ang:Forward() * -10
return pos, ang
end
	...
	self:SetNextPrimaryFire( CurTime() + (1 / self.FireRate) )
		...
		if SERVER then
			...
			local MDat = {
				...
				MotorSound = "acf_extra/cannons/120mm-240mm/the_big_guns/183mm.wav",
