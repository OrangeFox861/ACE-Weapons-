...
SWEP.Purpose = "Heavy slavic bratatata"
SWEP.Spawnable = true
SWEP.Slot = 2
SWEP.SlotPos = 1
SWEP.Author = " "
...
SWEP.ViewModel = "models/ace+/view_pkm.mdl"
SWEP.WorldModel = "models/ace+/world_pkm.mdl"
SWEP.HoldType = "ar2"
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetVec = Vector(15, -1.5, -6.5)
...
function SWEP:DoShootEffects()
    ...
    -- Создаем эффект независимо от режима камеры
    util.Effect("MuzzleEffect", effectdata)
    
    -- Также создаем стандартные эффекты
    self:ShootEffects()
end
