...
SWEP.Purpose = "Fast mod French bullet shooter"
SWEP.Spawnable = true
...
SWEP.ViewModel = "models/ace+/v_famas.mdl"
SWEP.WorldModel = "models/ace+/w_famas.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 0 + ang:Up() * 0 + ang:Forward() * 0
return pos, ang
end
...
sound.Add( {
    name = "CA.FAMAS.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/Famas/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/Famas/reload2.wav"
} )
sound.Add( {
    name = "CA.FAMAS.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/Famas/reload3.wav"
} )
sound.Add( {
    name = "CA.FAMAS.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/Famas/select.wav"
} )
