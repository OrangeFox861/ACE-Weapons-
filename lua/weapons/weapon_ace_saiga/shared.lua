...
SWEP.Purpose = "Slavik shotgun (caliber 4mm because no one wants to catch 12mm pellets)"
SWEP.Spawnable = true
...
SWEP.ViewModel = "models/ace+/v_saiga_20k.mdl"
SWEP.WorldModel = "models/ace+/w_saiga_20k.mdl"
SWEP.HoldType = "ar2"
...
sound.Add( {
    name = "CA.SAIGA.Magout",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/Saiga/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/Saiga/reload2.wav"
} )
sound.Add( {
    name = "CA.SAIGA.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/Saiga/reload3.wav"
} )
sound.Add( {
    name = "CA.SAIGA.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/sg/Saiga/select.wav"
} )
