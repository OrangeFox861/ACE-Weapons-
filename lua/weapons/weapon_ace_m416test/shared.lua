...
SWEP.ViewModel = "models/ace+/v_m416.mdl"
SWEP.WorldModel = "models/ace+/w_m416.mdl"
SWEP.HoldType = "ar2"
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetVec = Vector(4.5, -1, 5)
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m416/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m416/reload2.wav"
} )
sound.Add( {
    name = "CA.M416.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m416/reload3.wav"
} )
sound.Add( {
    name = "CA.M416.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/m416/select.wav"
} )
