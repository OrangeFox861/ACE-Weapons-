...
SWEP.Purpose = "Korean bullet shooter"
SWEP.Spawnable = true
...
--Main settings--
SWEP.FireRate = 13.3 --Rounds per second
...
SWEP.HeatReductionRate = 915.75 --Heat loss per second when not firing
...
SWEP.ViewModel = "models/ace+/v_K2.mdl"
SWEP.WorldModel = "models/ace+/w_K2.mdl"
SWEP.HoldType = "ar2"
...
pos = pos + ang:Right() * 0 + ang:Up() * -38 + ang:Forward() * 0
return pos, ang
end
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/K2/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/K2/reload2.wav"
} )
sound.Add( {
    name = "CA.K2.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/K2/reload3.wav"
} )
sound.Add( {
    name = "CA.K2.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/K2/select.wav"
} )
