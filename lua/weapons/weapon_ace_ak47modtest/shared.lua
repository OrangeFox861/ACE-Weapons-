...
SWEP.Purpose = "Mod slavic bullet thrower"
SWEP.Spawnable = true
SWEP.Slot = 2
SWEP.SlotPos = 1
SWEP.Author = " "
...
SWEP.HeatPerShot = 36.3 --Heat generated per shot
SWEP.HeatMax = 36.3 --Maximum heat - determines max rate at which recoil is applied to eye angles
...
SWEP.AngularRecoil = 36.3	--Amount of angular recoil
...
SWEP.ViewPunchAmount = 1.82 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
SWEP.ViewPunchAmountSide = 0.15
SWEP.ViewPunchAmountRoll = 0.91
...
pos = pos + ang:Right() * 1 + ang:Up() * -5 + ang:Forward() * 10
return pos, ang
end
...
if CLIENT then
	...
	function SWEP:DrawWorldModel()
		...
		if (IsValid(_Owner)) then
			...
			local offsetAng = Angle(190, 0, 120)
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak47/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak47/reload2.wav"
} )
sound.Add( {
    name = "CA.ak47.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/ar/ak47/reload3.wav"
} )
sound.Add( {
    name = "CA.ak47.Select",
    channel = CHAN_STATIC,
