...
--			surface.SetTextColor( 0, 0, 0 )
--			surface.SetTextPos( x - 48, y + 38)
--			surface.DrawText(" ___^___    75")
--			
--			surface.SetTextPos( x - 36, y + 110 )
--			surface.DrawText(" __^__      125")
--			
--			surface.SetTextPos( x - 24, y + 195 )
--			surface.DrawText( " _^_        175")
--
--            surface.SetTextColor( 0, 0, 0 )
--			surface.SetTextPos( x - 10, y + 245 )
--			surface.DrawText( "-:-     200")


surface.SetTexture( surface.GetTextureID( "ace+/sprites/M72RE" ) )
