...
SWEP.AngularRecoil = 14.0625	--Amount of angular recoil
...
SWEP.ViewPunchAmount = 0.25 --Degrees to punch the view upwards each shot - does not actually move crosshair, just a visual effect
...
SWEP.ViewModel = "models/ace+/v_ump.mdl"
SWEP.WorldModel = "models/ace+/w_ump.mdl"
SWEP.HoldType = "smg"
...
pos = pos + ang:Right() * 0 + ang:Up() * -4 + ang:Forward() * 7
return pos, ang
end
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/ump/reload1.wav"
} )
...
sound.Add( {
    ...
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/ump/reload2.wav"
} )
sound.Add( {
    name = "CA.UMP.Handle",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/ump/reload3.wav"
} )
sound.Add( {
    name = "CA.UMP.Select",
    channel = CHAN_STATIC,
    volume = 0.5,
    level = 80,
    sound       = "Weapons/smg/ump/select.wav"
} )
...
function SWEP:InitBulletData()
	...
	--self.BulletData.DragCoef = 0.03 --Alternatively manually set it
